...
class DatasetConditional(Dataset):
    def __init__(self, tensor: Tensor, condition_tensor: Tensor, inits_tensor: Tensor):
        """
        ...
        Args:
            ...
            inits_tensor (Tensor): The initial states tensor
                The tensor containing the initial states of the environment.

        """
        super().__init__()
        self.tensor = tensor.clone()
        self.condition_tensor = condition_tensor.clone()
        self.inits_tensor = inits_tensor.clone()
    ...
    def __getitem__(self, idx):
        ...
        """
        return self.tensor[idx], self.condition_tensor[idx], self.inits_tensor[idx]